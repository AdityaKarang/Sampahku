    ...
    private fun upImage() {
        ...
        ref.putFile(imgUri!!)
            .addOnSuccessListener { taskSnapshot ->
                ...
                updtProfile(uploadedImageUrl)
            }
            .addOnFailureListener { e ->
                Toast.makeText(this, "failed upload image due to ${e.message}", Toast.LENGTH_SHORT)
                    .show()
            }
    }

    private fun updtProfile(uploadedImageUrl: String) {
        ...
        ref.child(auth.uid!!)
            ...
            .addOnFailureListener { e ->
                Toast.makeText(
                    this,
                    "failed update profile due to ${e.message}",
                    Toast.LENGTH_SHORT
                ).show()
            }
    }
        ...
        ref.child(auth.uid!!)
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    try {
                        Glide.with(this@EditProfileActivity).load(imgProfile)
...
//                imageUri = data!!.data
                ...
                binding.tvProfile.setImageURI(imgUri)
            } else {
